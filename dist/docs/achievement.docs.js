...
exports.achievementPaths = void 0;
const achievementBody = {
    ...
    properties: {
        ...
        foto_urls: {
            type: "array",
            items: { type: "string" },
            description: "URL foto hasil upload. File diunggah langsung dari browser ke Cloudinary (unsigned preset), backend hanya menyimpan URL-nya.",
            example: ["https://res.cloudinary.com/demo/image/upload/v1/hmif/foto.jpg"],
        },
    },
};
exports.achievementPaths = {
    "/api/achievements": {
        get: {
        ...
        post: {
            ...
            description: "Butuh login. Hanya role `mba` dan `superUser` yang diizinkan, role `departement` dapat 403.",
            tags: ["Achievement"],
            security: [{ bearerAuth: [] }],
            requestBody: {
                required: true,
